...
def factor():                   return [function_call, method_call, indexed_variable, bracketed_expression, (notsym, factor), private_list, atom], Optional(leftsquarebrack, expression, ZeroOrMore(colon, expression), rightsquarebrack)
